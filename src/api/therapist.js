...
export const therapistService = {
  getAllTherapists: (page = 1, limit = 10) => api.get(`/therapists?page=${page}&limit=${limit}`),
  ...
  verifyTherapist: (therapistId) => api.put(`/therapists/verify/${therapistId}`, { status: "verified" }),
};