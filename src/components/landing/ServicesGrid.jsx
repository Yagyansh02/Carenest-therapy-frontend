...
const services = [
  {
    title: 'Affordable Student Therapy',
    description: 'Sessions with postgraduate students under expert supervision.',
    image: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    title: 'Professional Counseling',
    description: 'Expert guidance from licensed and experienced therapists.',
    image: 'https://images.unsplash.com/photo-1516534775068-ba3e7458af70?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    title: 'Anxiety & Stress',
    description: 'Manage daily stressors and find your emotional balance.',
    image: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    title: 'Depression Management',
    description: 'Supportive care to help you navigate difficult times.',
    image: 'https://images.unsplash.com/photo-1508214751196-bcfd4ca60f91?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    title: 'Personal Growth',
    description: 'Unlock your potential with tailored therapy goals.',
    image: 'https://images.unsplash.com/photo-1511632765486-a01980e01a18?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80',
  },
  {
    title: 'Relationship Guidance',
    description: 'Improve communication and resolve conflicts effectively.',
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">
            From affordable student sessions to professional counseling, we offer services tailored to your needs.
          </p>
        </div>
