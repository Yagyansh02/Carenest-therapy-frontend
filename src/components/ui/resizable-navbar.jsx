...
export const MobileNavToggle = ({ isOpen, onClick }) => {
  return isOpen ? (
    <X className="text-black cursor-pointer" onClick={onClick} size={24} />
  ) : (
    <Menu className="text-black cursor-pointer" onClick={onClick} size={24} />
  );
};

export const NavbarLogo = ({ href = "/", children, logoSrc, logoText }) => {
  return (
    <a
      href={href}
    ...
    >
      ...
      <span className="font-medium text-black">{logoText || children}</span>
    </a>
  );
};
